    ...
    <Layout>
      ...
      <ResourcesShell>
        ...
        <section className="relative w-full overflow-hidden">
          ...
          <div className="relative z-10 mx-auto px-6 text-center max-w-[720px] pt-16 md:pt-20 xl:pt-24 pb-20 md:pb-24">
            <h1
              className="text-4xl md:text-[50px] font-extrabold tracking-tight"
              style={{ lineHeight: 1.1, marginBottom: 16, color: COLORS.neutral }}
            >
              <span>Help </span>
            ...
            <p
              ...
              style={{ color: COLORS.neutralLight, maxWidth: 500 }}
            >
        ...
        <section
          className="relative"
          style={{ zIndex: 20, paddingBottom: 80 }}
        >
          <div className="mx-auto px-6" style={{ maxWidth: 1100 }}>
            {loading ? (
              <div className="text-center py-16" style={{ color: COLORS.neutralLight }}>Loading categories...</div>
            ) : error ? (
              <div className="text-center py-16">
                <p className="text-red-500 text-sm mb-2">Failed to load categories</p>
                <p className="text-xs" style={{ color: COLORS.neutralLight }}>{error}</p>
              </div>
            ) : categories.length === 0 ? (
              ...
              >
                {categories.map((cat, idx) => (
                  <Link
                    ...
                    className="group fade-up cursor-pointer"
                    style={{
                  ...
                  >
                    ...
                    >
                      <div style={{ padding: '28px 28px 32px' }}>
                        ...
                        <h2
                          className="text-[17px] font-extrabold group-hover:text-primary-600 transition-colors duration-200"
                          style={{ marginBottom: 8, lineHeight: 1.35, color: COLORS.neutral }}
                        >
